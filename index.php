...
EOFILE;
    ...
    while ($file = readdir($handle)) {
        if ($file!='..' && $file!='.')
            if (is_dir("$curdir/$file") && !in_array($file,$projectsListIgnore)) {
                $projects .= '<li><a href="/'.$file.'">'.$file.'</a></li>';
            }
    }
    closedir($handle);
    ...
    //Custom TOOLS Menu:
    if (file_exists(__DIR__.'/admin.php')) $tools.="<li class='admin'><a href='admin.php'><b><i>Admin</i></b></a></li>";
...
<body>
	...
	<ul class="tools">
		...
		<li><a href="tools/$adminer.php?server=127.0.0.1&username=root"><B>Adminer Database Manager</B></a> | <a href="tools/reg.php"><B>Regular Expressions Tester</B></a> | <a href="?phpinfo=1"><b>phpinfo()</b></a></li>
		<li><a href="?errorLog=1">PHP Error Log</a> | <a href="?mailLog=1">PHP Mail Log</a> | <a href="tools/xcache/"><i>PHP XCache Stats</i></a> | <a href="?sendmail=1"><i>Test mail()</i></a></li>
		$tools
	</ul>
	$info
